...
class MollieHttpAdapterPicker implements \Mollie\Api\HttpAdapter\MollieHttpAdapterPickerInterface
{
    ...
    public function pickHttpAdapter($httpClient)
    {
        ...
        if ($httpClient instanceof \_PhpScoperc4e61a44a745\GuzzleHttp\ClientInterface) {
    ...
    {
        return \interface_exists('\\' . \_PhpScoperc4e61a44a745\GuzzleHttp\ClientInterface::class);
    }
    /**
     * @return int|null
     */
    private function guzzleMajorVersionNumber()
    {
        ...
        if (\defined('\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            return (int) \_PhpScoperc4e61a44a745\GuzzleHttp\ClientInterface::MAJOR_VERSION;
        }
        // Before Guzzle 7
        if (\defined('\\GuzzleHttp\\ClientInterface::VERSION')) {
            return (int) \_PhpScoperc4e61a44a745\GuzzleHttp\ClientInterface::VERSION[0];
        }
        return null;
    }
}
