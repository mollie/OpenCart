					...
					<div id="store<?php echo $store['store_id']; ?>" class="<?php echo $store['store_id'] === 0 ? 'active' : ''; ?>">
						...
						<div id="mollie-options-<?php echo $store['store_id']; ?>" class="active vtabs-content">
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="<?php echo $store['store_id']; ?><?php echo $code; ?>_api_key"> <?php echo $api_required ? '<span class="required">*</span>' : '' ?> <?php echo $entry_api_key; ?><br /><span class="help"><?php echo $help_api_key; ?></span></label>
									<div class="col-sm-10">
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label"><?php echo $entry_show_order_canceled_page; ?><br /><span class="help"><?php echo $help_show_order_canceled_page; ?></span></label>
									<div class="col-sm-10">
								...
								<div class="form-group">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label"><?php echo $entry_single_click_payment; ?><br /><span class="help"><?php echo $help_single_click_payment; ?></span></label>
											<div class="col-sm-10">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label"><?php echo $entry_payment_link; ?><br /><span class="help"><?php echo $help_payment_link; ?></span></label>
											<div class="col-sm-10">
												<label class="radio-inline">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label" for="<?php echo $store["store_id"] ?>-input-mollie-component"><?php echo $entry_mollie_component; ?><br /><span class="help"><?php echo $help_mollie_component; ?></span></label>
											<div class="col-sm-10">
						...
						<div id="mollie-mail-<?php echo $store['store_id']; ?>" class="vtabs-content">
							<div id="languages<?php echo $store['store_id']; ?>" class="htabs">
					            <?php foreach ($languages as $language) { ?>
								...
								<fieldset>
									...
									<table class="form">
										...
										<tr>
											<td><?php echo $entry_email_body; ?></td>
											<td>
												<textarea name="<?php echo $store['store_id']; ?>_<?php echo $code; ?>_payment_link_email[<?php echo $language['language_id']; ?>][body]" placeholder="<?php echo $entry_email_body; ?>" id="input-payment-link-body<?php echo $store['store_id']; ?><?php echo $language['language_id']; ?>" cols="40" rows="5" class="form-control"><?php echo isset($store[$code . '_payment_link_email'][$language['language_id']]) ? $store[$code . '_payment_link_email'][$language['language_id']]['body'] : $text_pay_link_text; ?></textarea>
						...
						<div id="support-<?php echo $store['store_id']; ?>" class="vtabs-content">
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="<?php echo $store['store_id']; ?>_<?php echo $code; ?>_debug_mode" class="form-control">
...
<script type="text/javascript"><!--
	$('#stores a').tabs();
    <?php foreach($stores as $store) { ?>
	$('#languages<?php echo $store['store_id']; ?> a').tabs();

    <?php foreach ($languages as $language) { ?>
    CKEDITOR.replace('input-recurring-body<?php echo $store['store_id']; ?><?php echo $language['language_id']; ?>', {
    ...
    CKEDITOR.replace('input-payment-link-body<?php echo $store['store_id']; ?><?php echo $language['language_id']; ?>', {
        filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
        filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
        filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
        filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
