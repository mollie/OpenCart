...
use _PhpScoperf6dbed3faadf\GuzzleHttp\Client;
use _PhpScoperf6dbed3faadf\GuzzleHttp\ClientInterface;
use _PhpScoperf6dbed3faadf\GuzzleHttp\Exception\GuzzleException;
use _PhpScoperf6dbed3faadf\GuzzleHttp\HandlerStack;
use _PhpScoperf6dbed3faadf\GuzzleHttp\Psr7\Request;
use _PhpScoperf6dbed3faadf\GuzzleHttp\RequestOptions as GuzzleRequestOptions;
use Mollie\Api\Exceptions\ApiException;
use _PhpScoperf6dbed3faadf\Psr\Http\Message\ResponseInterface;
final class Guzzle6And7MollieHttpAdapter implements \Mollie\Api\HttpAdapter\MollieHttpAdapterInterface
{
    ...
    public function __construct(\_PhpScoperf6dbed3faadf\GuzzleHttp\ClientInterface $httpClient)
    {
    ...
    public static function createDefault()
    {
        ...
        $handlerStack = \_PhpScoperf6dbed3faadf\GuzzleHttp\HandlerStack::create();
        $handlerStack->push($retryMiddlewareFactory->retry());
        $client = new \_PhpScoperf6dbed3faadf\GuzzleHttp\Client([\_PhpScoperf6dbed3faadf\GuzzleHttp\RequestOptions::VERIFY => \_PhpScoperf6dbed3faadf\Composer\CaBundle\CaBundle::getBundledCaBundlePath(), \_PhpScoperf6dbed3faadf\GuzzleHttp\RequestOptions::TIMEOUT => self::DEFAULT_TIMEOUT, \_PhpScoperf6dbed3faadf\GuzzleHttp\RequestOptions::CONNECT_TIMEOUT => self::DEFAULT_CONNECT_TIMEOUT, 'handler' => $handlerStack]);
    ...
    {
        $request = new \_PhpScoperf6dbed3faadf\GuzzleHttp\Psr7\Request($httpMethod, $url, $headers, $httpBody);
        try {
            $response = $this->httpClient->send($request, ['http_errors' => \false]);
        } catch (\_PhpScoperf6dbed3faadf\GuzzleHttp\Exception\GuzzleException $e) {
     ...
     * @throws ApiException
     */
    private function parseResponseBody(\_PhpScoperf6dbed3faadf\Psr\Http\Message\ResponseInterface $response)
    {
    ...
    public function versionString()
    {
        if (\defined('\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            // Guzzle 7
            return "Guzzle/" . \_PhpScoperf6dbed3faadf\GuzzleHttp\ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\\GuzzleHttp\\ClientInterface::VERSION')) {
            // Before Guzzle 7
            return "Guzzle/" . \_PhpScoperf6dbed3faadf\GuzzleHttp\ClientInterface::VERSION;
        }
        return null;
    }
}
