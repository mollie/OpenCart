...
class Order extends \Mollie\Api\Resources\BaseResource
{
    ...
    {
        $body = ["billingAddress" => $this->billingAddress, "shippingAddress" => $this->shippingAddress, "orderNumber" => $this->orderNumber, "redirectUrl" => $this->redirectUrl, "webhookUrl" => $this->webhookUrl];
