...
class Profile extends \Mollie\Api\Resources\BaseResource
{
    ...
    {
        $body = ["name" => $this->name, "website" => $this->website, "email" => $this->email, "phone" => $this->phone, "categoryCode" => $this->categoryCode, "businessCategory" => $this->businessCategory, "mode" => $this->mode];
