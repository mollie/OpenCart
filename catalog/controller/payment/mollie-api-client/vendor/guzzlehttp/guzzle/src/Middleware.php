    ...
    public static function cookies()
    {
        return function (callable $handler) {
            return function ($request, array $options) use($handler) {
                ...
                } elseif (!$options['cookies'] instanceof \_PhpScoper5bbb1f4b001f3\GuzzleHttp\Cookie\CookieJarInterface) {
                    throw new \InvalidArgumentException('_PhpScoper5bbb1f4b001f3\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
