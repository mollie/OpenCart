...
class RetryMiddleware
{
     ...
     * @return mixed
     */
    private function onFulfilled(\_PhpScoper5f491826ce6ce\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return callable
     */
    private function onRejected(\_PhpScoper5f491826ce6ce\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return self
     */
    private function doRetry(\_PhpScoper5f491826ce6ce\Psr\Http\Message\RequestInterface $request, array $options, \_PhpScoper5f491826ce6ce\Psr\Http\Message\ResponseInterface $response = null)
    {
