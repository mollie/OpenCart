 ...
 */
function queue(\_PhpScoper5ce26f1fe2920\GuzzleHttp\Promise\TaskQueueInterface $assign = null)
{
    static $queue;
    if ($assign) {
        $queue = $assign;
    } elseif (!$queue) {
        $queue = new \_PhpScoper5ce26f1fe2920\GuzzleHttp\Promise\TaskQueue();
    }
    return $queue;
}
/**
...
{
    $queue = queue();
    $promise = new \_PhpScoper5ce26f1fe2920\GuzzleHttp\Promise\Promise([$queue, 'run']);
