 ...
 */
function queue(\_PhpScoper5bbb1f4b001f3\GuzzleHttp\Promise\TaskQueueInterface $assign = null)
{
    static $queue;
    if ($assign) {
        $queue = $assign;
    } elseif (!$queue) {
        $queue = new \_PhpScoper5bbb1f4b001f3\GuzzleHttp\Promise\TaskQueue();
    }
    return $queue;
}
/**
...
{
    $queue = queue();
    $promise = new \_PhpScoper5bbb1f4b001f3\GuzzleHttp\Promise\Promise([$queue, 'run']);
