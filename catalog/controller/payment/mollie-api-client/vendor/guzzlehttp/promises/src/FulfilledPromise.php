 ...
 */
class FulfilledPromise implements \_PhpScoper5f491826ce6ce\GuzzleHttp\Promise\PromiseInterface
{
    private $value;
    ...
    public function then(callable $onFulfilled = null, callable $onRejected = null)
    {
        ...
        $queue = queue();
        $p = new \_PhpScoper5f491826ce6ce\GuzzleHttp\Promise\Promise([$queue, 'run']);
        $value = $this->value;
