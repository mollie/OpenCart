 ...
 * @return string
 */
function str(\_PhpScoper5bbb1f4b001f3\Psr\Http\Message\MessageInterface $message)
{
    if ($message instanceof \_PhpScoper5bbb1f4b001f3\Psr\Http\Message\RequestInterface) {
