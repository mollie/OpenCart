...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoper5f491826ce6ce\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoper5f491826ce6ce\Psr\Http\Message\StreamInterface $stream)
    {
