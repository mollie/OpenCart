 ...
 */
class LimitStream implements \_PhpScoper5b87e821469bb\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\_PhpScoper5b87e821469bb\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
