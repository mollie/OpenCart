 ...
 */
class LimitStream implements \_PhpScoper5bbb1f4b001f3\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\_PhpScoper5bbb1f4b001f3\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
