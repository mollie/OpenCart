...
use _PhpScoper5f491826ce6ce\GuzzleHttp\Client;
use _PhpScoper5f491826ce6ce\GuzzleHttp\ClientInterface;
use _PhpScoper5f491826ce6ce\GuzzleHttp\Exception\GuzzleException;
use _PhpScoper5f491826ce6ce\GuzzleHttp\Psr7\Request;
...
class MollieApiClient
{
     ...
     */
    public function __construct(\_PhpScoper5f491826ce6ce\GuzzleHttp\ClientInterface $httpClient = null)
    {
        $this->httpClient = $httpClient ? $httpClient : new \_PhpScoper5f491826ce6ce\GuzzleHttp\Client([\_PhpScoper5f491826ce6ce\GuzzleHttp\RequestOptions::VERIFY => \_PhpScoper5f491826ce6ce\Composer\CaBundle\CaBundle::getBundledCaBundlePath(), \_PhpScoper5f491826ce6ce\GuzzleHttp\RequestOptions::TIMEOUT => self::TIMEOUT]);
        ...
        if (\defined('\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            // Guzzle 7
            $this->addVersionString("Guzzle/" . \_PhpScoper5f491826ce6ce\GuzzleHttp\ClientInterface::MAJOR_VERSION);
        } elseif (\defined('\\GuzzleHttp\\ClientInterface::VERSION')) {
            // Before Guzzle 7
            $this->addVersionString("Guzzle/" . \_PhpScoper5f491826ce6ce\GuzzleHttp\ClientInterface::VERSION);
        }
    }
    ...
    public function performHttpCallToFullUrl($httpMethod, $url, $httpBody = null)
    {
        ...
        $request = new \_PhpScoper5f491826ce6ce\GuzzleHttp\Psr7\Request($httpMethod, $url, $headers, $httpBody);
        try {
            $response = $this->httpClient->send($request, ['http_errors' => \false]);
        } catch (\_PhpScoper5f491826ce6ce\GuzzleHttp\Exception\GuzzleException $e) {
     ...
     * @throws ApiException
     */
    private function parseResponseBody(\_PhpScoper5f491826ce6ce\Psr\Http\Message\ResponseInterface $response)
    {
