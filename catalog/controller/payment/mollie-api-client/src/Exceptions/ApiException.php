...
class ApiException extends \Exception
{
     ...
     */
    public function __construct($message = "", $code = 0, $field = null, \_PhpScoper5f491826ce6ce\GuzzleHttp\Psr7\Response $response = null, \Throwable $previous = null)
    {
        if (!empty($field)) {
    ...
    public static function createFromResponse($response, \Throwable $previous = null)
    {
        ...
        return new self("Error executing API call ({$object->status}: {$object->title}): {$object->detail}", $response->getStatusCode(), $field, $response, $previous);
    }
    /**
     * @return string|null
     */
