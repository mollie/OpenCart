...
<div id="content">
	...
	<div class="box">
		...
		<div class="content">
			<div class="htabs">
				<?php foreach ($shops as $shop) { ?>
					<a class="<?php echo $shop['id'] === 0 ? 'active' : ''; ?>" href="#store<?php echo $shop['id']; ?>"><?php echo $shop['name']; ?></a>
				<?php } ?>
			</div>
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
				<?php foreach ($shops as $shop) { ?>
					<div id="store<?php echo $shop['id']; ?>" class="<?php echo $shop['id'] === 0 ? 'active' : ''; ?>">
						<div class="vtabs">
							<a class="active" href="#payment-methods-<?php echo $shop['id']; ?>"><?php echo $entry_payment_method; ?></a>
							<a href="#payment-statuses-<?php echo $shop['id']; ?>"><?php echo $title_payment_status; ?></a>
							<a href="#mollie-options-<?php echo $shop['id']; ?>"><?php echo $title_global_options; ?></a>
							<a href="#about-module-<?php echo $shop['id']; ?>"><?php echo $title_mod_about; ?></a>
							<a href="#support-<?php echo $shop['id']; ?>">Support</a>
						</div>

						<div id="payment-methods-<?php echo $shop['id']; ?>" class="active vtabs-content">
						...
						<div id="payment-statuses-<?php echo $shop['id']; ?>" class="vtabs-content">
							<div class="form-group">
						...
						<div id="mollie-options-<?php echo $shop['id']; ?>" class="vtabs-content">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="stores[<?php echo $shop['id']; ?>][<?php echo $code; ?>_creditcard_max_amount]"><?php echo $entry_creditcard_max_amount; ?> <span class="help"><?php echo $help_creditcard_max_amount; ?></span></label>
								<div class="col-sm-10">
									<input type="text" name="stores[<?php echo $shop['id']; ?>][<?php echo $code; ?>_creditcard_max_amount]" placeholder="<?php echo $eg_creditcard_max_amount; ?>" value="<?php echo $stores[$shop['id']][$code . '_creditcard_max_amount']; ?>" id="stores[<?php echo $shop['id']; ?>][<?php echo $code; ?>_creditcard_max_amount]" class="form-control"/>
								</div>
							</div>
						</div>

						<div id="about-module-<?php echo $shop['id']; ?>" class="vtabs-content">
							<div class="form-group">
						...
						<div id="support-<?php echo $shop['id']; ?>" class="vtabs-content">
							<fieldset>
